...
import com.kindredgroup.unibetlivetest.entity.*;
import com.kindredgroup.unibetlivetest.repository.*;
...
public class DataPopulate {
    ...
    public void createRealPsgData() {
        ...
        final Event realMadridVsPsg = eventRepository.save(new Event().setName("Unibet IT vs Real madrid")
        ...
        selectionRepository.save(new Selection()
                ...
                .setMarket(marketResultatDuMatch));
        // for testing purpose
        Selection selectionTest = selectionRepository.save(new Selection()
                .setName("Match closed testing")
                .setState(SelectionState.CLOSED)
                .setCurrentOdd(new BigDecimal("4.5"))
                .setResult(SelectionResult.WON)
                .setMarket(marketResultatDuMatch));
        betRepository.save(new Bet().setSelection(selectionTest));
